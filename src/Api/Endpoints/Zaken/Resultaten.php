...
#[ZgwResource(schema: 'Resultaat', component: 'zaken')]
class Resultaten extends AbstractEndpoint implements CreatesResource, DeletesResource, ListsResources, PatchesResource, ReplacesResource, ShowsResource
{
    use Delete;
    use Index;
    use Patch;
