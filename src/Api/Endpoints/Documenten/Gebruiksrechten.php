...
#[ZgwResource(schema: 'Gebruiksrechten', component: 'documenten')]
class Gebruiksrechten extends AbstractEndpoint implements CreatesResource, DeletesResource, ListsResources, PatchesResource, ReplacesResource, ShowsResource
{
    use Delete;
    use Index;
    use Patch;
    ...
    protected string $endpoint = 'gebruiksrechten';
}
