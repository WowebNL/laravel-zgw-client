...
#[ZgwResource(schema: 'Eigenschap', component: 'catalogi')]
class Eigenschappen extends AbstractEndpoint implements CreatesResource, DeletesResource, ListsResources, PatchesResource, ReplacesResource, ShowsResource
{
    use Delete;
    use Index;
    use Patch;
