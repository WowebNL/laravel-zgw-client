...
#[ZgwResource(schema: 'ZaakObjectType', component: 'catalogi')]
class Zaakobjecttypen extends AbstractEndpoint implements CreatesResource, DeletesResource, ListsResources, PatchesResource, ReplacesResource, ShowsResource
{
    use Delete;
    use Index;
    use Patch;
